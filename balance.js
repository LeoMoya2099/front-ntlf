document.getElementById('check-balance').addEventListener('click', async () => {
    ...
    try {
      const response = await fetch('https://proyectofllstk.ue.r.appspot.com/check-balance', {
        method: 'POST',
        headers: {
  ...
  document.getElementById('withdraw').addEventListener('click', async () => {
    ...
    try {
      const response = await fetch('https://proyectofllstk.ue.r.appspot.com/withdraw', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  document.getElementById('deposit').addEventListener('click', async () => {
    ...
    try {
      const response = await fetch('https://proyectofllstk.ue.r.appspot.com/deposit', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
